      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-20">
          ...
          <div className="space-y-6">
            {/* Call */}
            <div className="group relative backdrop-blur-xl bg-white/[0.02] border border-white/10 p-8 rounded-3xl hover:bg-white/[0.05] transition-all duration-500 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative flex items-start gap-6">
                <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
          ...
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="relative h-full min-h-[500px] rounded-3xl overflow-hidden border border-white/10 backdrop-blur-xl bg-white/[0.02]">
              <iframe
        ...
        {/* CTA Section */}
        <div className="relative backdrop-blur-xl bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 p-12 rounded-3xl overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto">
            ...
            <button className="group relative px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full font-semibold text-white hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 overflow-hidden">
